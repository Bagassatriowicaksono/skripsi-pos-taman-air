...
class Customer extends CI_Controller
{
    ...
    public function store()
    {
        ...
        if ($this->form_validation->run() != false) {
            $data = [
                'kode_customer' => xss_protect($this->input->post("kode_customer", true)),
                'nama'          => xss_protect($this->input->post("nama", true)),
                'alamat'        => xss_protect($this->input->post("alamat", true)),
                'hp'            => xss_protect($this->input->post("hp", true)),
    ...
    public function delete()
    {
        ...
        if ($cek->num_rows() > 0) {
            ...
            $this->db->update("customer", ['deleted_at' => date('Y-m-d H:i:s')]);
