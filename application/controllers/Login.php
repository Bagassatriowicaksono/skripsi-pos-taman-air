...
class Login extends CI_Controller
{
    ...
    {
        $user = xss_protect($this->input->post('user', true));
        $pass = xss_protect($this->input->post('pass', true));
        // auth
        $proses_login = $this->db->query("SELECT * FROM login WHERE user = ? AND deleted_at IS NULL", array($user));
