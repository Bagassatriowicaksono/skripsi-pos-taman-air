            ...
            <div class="col-sm-12">
                ...
                <div class="card card-rounded">
                    <div class="card-header bg-success text-white">
                        <?= $title_web;?>
                        <a href="<?= base_url('customer/tambah'); ?>" class="btn btn-green ml-2"> Tambah Customer</a>
                    </div>
                    <div class="card-body">
            ...
            },
            {
                ...
                "render": function(data, type, row, meta) {
                    return `<a href="${base_url}customer/detail/${row.id}" 
                                    class="btn btn-green btn-sm" title="Detail Customer" role="button">
                                    <i class="fa fa-eye"></i>
                                </a>
                                <a href="${base_url}customer/edit/${row.id}" 
                                    class="btn btn-success btn-sm" title="Edit Customer" role="button">
