            ...
            <div class="col-sm-12">
                ...
                <div class="card card-rounded mt-4">
                    ...
                    <form method="post" action="<?= base_url('info/print');?>" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                        <input type="number" class="form-control" value="<?= $edit->pajak_default;?>"
                                            name="pajak_default" id="pajak_default" placeholder="" />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">
                                            Batas Jam Login <br> ( Kasir )
                                        </label>
                                        <div class="col-sm-8">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input type="time" class="form-control" value="<?= $edit->jam_awal;?>"
                                                        name="jam_awal" id="jam_awal" placeholder="" />
                                                </div>
                                                <div class="col-md-6">
                                                    <input type="time" class="form-control" value="<?= $edit->jam_akhir;?>"
                                                        name="jam_akhir" id="jam_akhir" placeholder="" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card-footer text-muted ">
                            <button type="submit" class="btn btn-success btn-md justify-content-right">
                                Simpan
                            </button>
                        </div>
                    </form>
