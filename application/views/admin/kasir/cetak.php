    <div class="modal-header">
        <h5 class="modal-title">Print Struk</h5>
        ...
        <div class="modal-body">
            ...
            <table style="width:100%">
                ...
                <tr>
                    ...
                    <td>
                        Rp<?= number_format($r->qty * $r->harga);?>
                    </td>
                </tr>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-sm-3">
                            <button type="submit" class="btn btn-warning btn-block mb-2">Cetak Struk</button>
                        </div>
                        <div class="col-sm-3">
...
Daftar Pesanan:
<?php $hr = 0; foreach($tp as $r){?>
<?= $r->nama_menu;?> x <?= $r->qty;?> = Rp<?= number_format($r->harga);?> 
<?php $hr  += $r->harga * $r->qty; }?>

Total : Rp<?= number_format($hr);?> 
<?php if($pp->pajak > 0){?>
Pajak : <?= $t->pajak;?> %
<?php }?>
...
<?php }?>
<?php if($pp->voucher > 0){?>
Voucher : Rp<?= number_format($t->voucher);?> 
<?php }?>
...
Kembali : Rp<?= number_format($t->dibayar-$t->grandtotal);?>" data-toggle="modal" data-target="#modelIdWA">
                        ...
                        <div class="col-sm-3">
                            <a href="<?= base_url('kasir');?>" class="btn btn-secondary btn-block">Selesai</a>
                        </div>
                    </div>
                </div>
            </div>
