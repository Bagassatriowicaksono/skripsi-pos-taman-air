...
<div class="table-responsive">
    <table class="table table-sm w-100" id="keranjang2" style="font-size:10pt;">
        <thead>
            <tr>
                <th>No</th>
                <th>Nama</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="javascript:void(0)" data-minus="<?= $item['id_menu'];?>"
                        class="badge badge-success p-2 minus"> - </a>
                    <span>
                        <input type="number" class="kr_sub" min="1" data-sub="<?= $item['id_menu'];?>"
                            value="<?= $item['qty'];?>">
                    </span>
                    <a href="javascript:void(0)" data-plus="<?= $item['id_menu'];?>"
                        class="badge badge-success p-2 plus"> + </a>
                </td>
            ...
            <tr>
                <td colspan="5">
                    <input type="text" value="<?= $item['keterangan'];?>" data-id="<?= $item['id_menu'];?>" 
                        class="form-control form-control-sm keteranganForm"
                        placeholder="Keterangan Pesanan :" name="keterangan">
                </td>
            </tr>
            <?php $no++; $total += $item['harga'] * $item['qty'];}}?>
        </tbody>
...
$(document).ready(function(e) {
    ...
    $('#keranjang2 tbody').on('change', '.keteranganForm', function() {
        var id = $(this).attr('data-id');
        var ket = $(this).val();
