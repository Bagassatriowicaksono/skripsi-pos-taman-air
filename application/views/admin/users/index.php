    ...
    <div class="container mt-5 py-5">
        <div class="row">
            <div class="col-md-12">
                ...
                <?php }?>
                <!-- <a href="users/tambah"><button class="btn btn-green float-right">Tambah Pengguna</button></a> -->
                <div class="clearfix"></div>
                <br>
                <div class="card card-rounded">
                    <div class="card-header bg-success text-white">
                        <?= $title_web;?>
                        <a href="users/tambah"><button class="btn btn-green ml-3">Tambah Pengguna</button></a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <br />
            ...
            },
            {
                ...
                "render": function(data, type, row, meta) {
                    return `<a href="${base_url}users/edit/${row.id}" 
                                    class="btn btn-success btn-sm" title="Edit Users" role="button">
